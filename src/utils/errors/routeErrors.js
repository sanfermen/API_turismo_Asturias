class RouteNameNotProvided extends Error {
	constructor(){
...
class RouteImageNotProvided extends Error {
	constructor(){
...
class RouteImageInvalid extends Error {
	constructor(){
...
class RouteInfoNotProvided extends Error {
	constructor(){
		super("Imagen de la ruta no introducida");
		this.statusCode = 400;
	}
...
class RouteInfoInvalidLength extends Error {
	constructor(){
...
class RouteCommentsInvalidLength extends Error {
	constructor(){
...
class RouteTrackInvalidLength extends Error {
	constructor(){
...
class RouteDistanceNotProvided extends Error {
	constructor(){
...
class RouteCoordinatesNotProvided extends Error {
	constructor(){
...
class RouteCoordinatesInvalid extends Error {
	constructor(){
...
class RouteCouncilNotProvided extends Error {
	constructor(){
...
class RouteCouncilNotFound extends Error {
	constructor(){
